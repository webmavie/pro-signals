        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card shadow mb-4">
                ...
                <form method="POST" action="<?=action_url()?>">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group" style="border:1px dashed black;">
                            ...
                            <div id="detalis_input">
                                <div class="row">
                                    <div class="col-10">
                                        <input type="text" name="detalis[]" placeholder="Detalis area" class="form-control"> 
                                    </div>
                                    <div class="col-2">
                            ...
                            <a onclick="return add_detalis_input();" class='form-control btn btn-warning'>Add detalis</a>
                        </div>
                        <div class="form-group">
                            <label>Order</label>
                    ...
                    <input type="hidden" name="form" value="add_packages">
                </form>
            </div>
        </div>
    </div>
