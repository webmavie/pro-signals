...
if (is_numeric($_GET['id'])) {
    $find=$db->get_onerow('skills', array('id' => $_GET['id']));
    if (empty($find['id'])) {
            ...
            <div class="card shadow mb-4">
                ...
                <form method="POST" action="<?=action_url()?>">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Percent *</label>
                            <input required type="number" name="percent" value="<?=$find['percent']?>" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Order</label>
                    ...
                    <input type="hidden" name="form" value="edit_skills">
                </form>
            </div>
        </div>
    </div>
