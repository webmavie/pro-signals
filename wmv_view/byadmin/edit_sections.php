...
if (is_numeric($_GET['id'])) {
    $find=$db->get_onerow('sections', array('id' => $_GET['id']));
    if (empty($find['id'])) {
        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card shadow mb-4">
                ...
                <form method="POST" action="<?=action_url()?>">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select class="form-control" disabled>
                                <option selected>download_ebook_bottom</option>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Content</label>
                            <textarea name="content" id="editor" style="height: 300px;" class="form-control"><?=$find['content']?></textarea>
                        </div>
                        <div class="form-group">
                            <label>Status *</label>
                    ...
                    <input type="hidden" name="form" value="edit_sections">
                </form>
            </div>
        </div>
    </div>
